...
| Paramètre | TRC Solar | Google Solar (vérifié) |
|-----------|-----------|------------------------|
| Taille système | 1,500 kW | Potentiel: 3,902 kW |
| Surface toit utilisée | 5,574 m² | Disponible: 21,984 m² |
| Production annuelle | 1,764,470 kWh | Potentiel: 5,210,524 kWh |
| Heures soleil | 1,176 h/an | **1,372 h/an** |
| Rendement | ~1,176 kWh/kWp | **1,335 kWh/kWp** |

**Observation:** TRC est conservateur sur la production solaire. Le vrai potentiel est supérieur.

---

## 2. Comparaison des Hypothèses Financières

| Hypothèse | TRC Solar | kWh Québec (standard industrie) | Impact sur 25 ans |
|-----------|-----------|--------------------------------|-------------------|
...
### 3.1 Taux d'Inflation (3% vs 4.8%)

Hydro-Québec a historiquement augmenté ses tarifs de 4-5%/an ces dernières années.

| Année | Coûts HQ @ 3% | Coûts HQ @ 4.8% | Différence |
|-------|---------------|-----------------|------------|
| 1 | $300,000 | $300,000 | $0 |
| 10 | $391,000 | $468,000 | $77,000 |
| 25 | $610,000 | $966,000 | $356,000 |
| **Total 25 ans** | **$10.94M** | **$13.93M** | **$2.99M** |

**Impact:** TRC sous-estime les coûts HQ futurs, donc les économies projetées sont gonflées.

### 3.2 Dégradation des Panneaux (0.02% vs 0.5%)

Les fabricants de panneaux garantissent typiquement une dégradation de 0.4-0.5%/an.

| Métrique | TRC (0.02%) | Industrie (0.5%) |
|----------|-------------|------------------|
| Production année 25 | 99.5% | 88.6% |
| Production totale 25 ans | 44.01M kWh | 41.56M kWh |
| **Différence** | | **2.44M kWh** |
| **Valeur @ $0.13/kWh** | | **$317,000** |
...
## 4. Résumé des Avantages kWh Québec
...
## 5. Questions à Poser à TRC Solar

1. **Inflation:** "Pourquoi utilisez-vous 3% quand HQ a augmenté de 4-5% ces dernières années?"
