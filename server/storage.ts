...
export class MemStorage implements IStorage {
  ...
  async createLead(lead: InsertLead): Promise<Lead> {
    ...
    const newLead: Lead = {
      ...
      economicStatus: null,
      propertyRelationship: lead.propertyRelationship || null,
      landlordName: null,
      landlordContact: null,
      authorizationStatus: null,
      roofCondition: null,
      roofAge: lead.roofAge || null,
      roofAgeYears: lead.roofAgeYears || null,
      lastRoofInspection: null,
      plannedRoofWork: null,
      ...
      qualificationBlockers: null,
      qualificationNextSteps: null,
  ...
  async createProcurationSignature(signature: InsertProcurationSignature): Promise<ProcurationSignature> {
    ...
    const newSignature: ProcurationSignature = {
      ...
      viewedAt: signature.viewedAt ?? null,
