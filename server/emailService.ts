...
function generateQuickAnalysisEmailHtml(data: QuickAnalysisData, lang: 'fr' | 'en', baseUrl: string): string {
  const t = {
    fr: {
      ...
      scenariosTitle: 'Vos 3 scénarios possibles',
      scenariosIntro: 'Nous avons analysé 11 scénarios (de 20% à 120% de compensation) pour vous proposer 3 options:',
      ...
      disclaimer: 'Cette analyse est une estimation préliminaire basée sur des moyennes régionales. Une validation avec vos données de consommation réelles fournira des projections plus précises. Le % de compensation indique quelle portion de votre consommation annuelle serait couverte par la production solaire (ex: 80% = le système couvre 80% de votre facture).',
    ...
    en: {
      ...
      scenariosTitle: 'Your 3 Possible Scenarios',
      scenariosIntro: 'We analyzed 11 scenarios (from 20% to 120% offset) to propose 3 options for you:',
      ...
      disclaimer: 'This analysis is a preliminary estimate based on regional averages. A validation with your actual consumption data will provide more accurate projections. The offset % indicates how much of your annual electricity consumption would be covered by solar production (e.g., 80% = the system covers 80% of your bill).',
