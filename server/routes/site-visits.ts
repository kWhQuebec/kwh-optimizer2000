...
router.get("/api/site-visits", authMiddleware, requireStaff, async (req: AuthRequest, res) => {
  try {
...
router.get("/api/sites/:siteId/visits", authMiddleware, requireStaff, async (req: AuthRequest, res) => {
  try {
...
router.get("/api/site-visits/:id", authMiddleware, requireStaff, async (req: AuthRequest, res) => {
  try {
...
router.post("/api/site-visits", authMiddleware, requireStaff, async (req: AuthRequest, res) => {
  try {
    const data = { ...req.body };
...
router.patch("/api/site-visits/:id", authMiddleware, requireStaff, async (req: AuthRequest, res) => {
  try {
    const data = { ...req.body };
    if (data.visitDate && typeof data.visitDate === 'string') {
      data.visitDate = new Date(data.visitDate);
...
router.delete("/api/site-visits/:id", authMiddleware, requireStaff, async (req: AuthRequest, res) => {
  try {
...
router.get("/api/site-visits/:id/pdf", authMiddleware, requireStaff, async (req: AuthRequest, res) => {
  try {
    const visit = await storage.getSiteVisit(req.params.id);
    if (!visit) {
      return res.status(404).json({ error: "Site visit not found" });
...
router.post("/api/site-visits/calculate-cost", authMiddleware, requireStaff, async (req: AuthRequest, res) => {
  try {
...
router.post("/api/site-visits/photos", authMiddleware, requireStaff, upload.single("photo"), async (req: AuthRequest, res) => {
  try {
    const file = req.file;
...
router.get("/api/sites/:siteId/photos", authMiddleware, async (req: AuthRequest, res) => {
  try {
...
router.get("/api/site-visits/:visitId/photos", authMiddleware, async (req: AuthRequest, res) => {
  try {
...
router.delete("/api/site-visits/photos/:photoId", authMiddleware, requireStaff, async (req: AuthRequest, res) => {
  try {
