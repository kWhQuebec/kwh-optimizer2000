...
const PORTFOLIO_SITES = [
  { name: "DÉMO — Pharmacie Santé Plus (G)", city: "Laval", type: "retail", tariff: "G" as const,
    address: "1920 Boulevard Le Corbusier", postalCode: "H7S 2K1", latitude: 45.5689, longitude: -73.7372,
  ...
  { name: "DÉMO — Centre Médical Laval (G)", city: "Laval", type: "medical", tariff: "G" as const,
    address: "300 Boulevard de la Concorde Est", postalCode: "H7G 2E6", latitude: 45.5776, longitude: -73.6815,
  ...
  { name: "DÉMO — Entrepôt Logistik (M)", city: "Boucherville", type: "warehouse", tariff: "M" as const,
    address: "1000 Rue Nobel", postalCode: "J4B 8E4", latitude: 45.5691, longitude: -73.4436,
  ...
  { name: "DÉMO — Tour Horizon Bureaux (G)", city: "Laval", type: "office", tariff: "G" as const,
    address: "3100 Boulevard Le Carrefour", postalCode: "H7T 2K7", latitude: 45.5656, longitude: -73.7528,
  ...
  { name: "DÉMO — Aliments Fresco (M)", city: "Montréal", type: "light_industrial", tariff: "M" as const,
    address: "7500 Boulevard des Galeries d'Anjou", postalCode: "H1M 3M4", latitude: 45.5975, longitude: -73.5674,
...
async function seedDemoSites() {
  ...
  const [s1Client] = await db.insert(clients).values({
    ...
    phone: "450-555-0101",
    address: "2137 Boulevard Curé-Labelle",
    city: "Laval",
    province: "QC",
    postalCode: "H7T 1L4",
  ...
  const [s2Client] = await db.insert(clients).values({
    ...
    phone: "819-555-0202",
    address: "3160 Boulevard Industriel",
    city: "Sherbrooke",
    province: "QC",
    postalCode: "J1L 1V8",
    accountManagerEmail: "malabarre@kwh.quebec",
