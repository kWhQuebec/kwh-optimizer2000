...
export function renderInvestmentBreakdown(ctx: PDFContext) {
  ...
  doc.text(formatSmartCurrency(simulation.incentivesHQSolar, ctx.lang), margin + 8, incentiveY + 38, { width: incentiveCardWidth - 16, align: "center" });
  doc.font("Helvetica");
  ...
  doc.fontSize(14).fillColor(COLORS.blue).font("Helvetica-Bold");
  doc.text(formatSmartCurrency(simulation.incentivesHQBattery, ctx.lang), bx + 8, incentiveY + 38, { width: incentiveCardWidth - 16, align: "center" });
  doc.font("Helvetica");
  ...
  doc.text(formatSmartCurrency(simulation.incentivesFederal, ctx.lang), fx + 8, incentiveY + 38, { width: incentiveCardWidth - 16, align: "center" });
  doc.font("Helvetica");
  ...
  doc.fontSize(14).fillColor(COLORS.gold).font("Helvetica-Bold");
  doc.text(formatSmartCurrency(simulation.taxShield, ctx.lang), tx + 8, incentiveY + 38, { width: incentiveCardWidth - 16, align: "center" });
  doc.font("Helvetica");
