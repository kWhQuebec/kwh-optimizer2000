...
export function renderTimeline(ctx: PDFContext) {
  ...
  // Smaller sub-header (on same page as Equipment)
  ...
  // Footer for shared Equipment + Timeline page
  drawPageFooter(ctx, t("Document confidentiel | Généré par kWh Québec | Équipement et échéancier", "Confidential document | Generated by kWh Québec | Equipment & timeline"));
}
