...
-   **PDF Report Generation**: Creates professional conversion-optimized PDF proposals with Project Snapshot, Financial Waterfall, Assumptions & Exclusions, Equipment & Warranties, Timeline, and 3-block Next Steps sections. All content sourced from `server/brandContent.ts` (SSOT). Matching PPTX presentations also generated.
