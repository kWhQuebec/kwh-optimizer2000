...
PublicHeader nav: Services (dropdown: Solaire commercial → /solaire-commercial, Stockage par batterie → /stockage-energie) | Portfolio | Ressources | 514.427.8871 | EN | Connexion. PublicFooter: 4-column grid (company, contact, navigation [Solaire commercial, Stockage, Portfolio, Ressources], legal) with RBQ number.
...
- `/solaire-commercial` — Commercial solar service page (incentives OSE 6.0/ITC/CCA, benefits, equipment specs, 5-step process, winter myths, target sectors, FAQ)
