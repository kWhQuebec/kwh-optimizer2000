...
import { pgTable, text, varchar, integer, serial, real, boolean, timestamp, jsonb, index } from "drizzle-orm/pg-core";
...
export const clients = pgTable("clients", {
  ...
  postalCode: text("postal_code"),
  notes: text("notes"),
  accountManagerEmail: text("account_manager_email").default("info@kwh.quebec"),
...
// ============================================
// GAMIFICATION + WORKFLOW TRACKING SYSTEM
// ============================================
