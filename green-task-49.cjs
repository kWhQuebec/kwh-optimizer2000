...
fs.writeFileSync('server/__tests__/hqBillParser.test.ts', testContent);
console.log('✅ Created server/__tests__/hqBillParser.test.ts');
console.log('   — 10 test cases: extraction, edge cases, type normalization, buffer');
