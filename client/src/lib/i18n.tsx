...
const translations: Translations = {
  ...
  "faq.subtitle": { fr: "Trouvez des réponses à vos questions sur le solaire et le stockage commercial au Québec", en: "Find answers to your questions about commercial solar and storage in Quebec" },
  ...
  "faq.item4.answer": { fr: "Le processus complet prend généralement 4-8 mois selon la complexité du projet: estimation gratuite (quelques minutes), étude personnalisée avec données Hydro-Québec réelles (7 jours), conception préliminaire et visite technique (2 semaines), plans et soumission forfaitaire (4-8 semaines), et permis et installation clé en main (10-18 semaines). Chaque projet est unique — l'appel découverte de 10 minutes permet de vous donner un échéancier précis.", en: "The complete process typically takes 4-8 months depending on project complexity: free estimate (a few minutes), personalized study with real Hydro-Québec data (7 days), preliminary design and site visit (2 weeks), plans and fixed-price quote (4-8 weeks), and permits and turnkey installation (10-18 weeks). Every project is unique — the 10-minute discovery call lets us give you a precise timeline." },

  "faq.item5.question": { fr: "Qu'est-ce que la procuration Hydro-Québec?", en: "What is Hydro-Québec procuration?" },
  "faq.item5.answer": { fr: "Une procuration est une autorisation qui nous permet d'accéder à votre profil de consommation détaillé (heure par heure) auprès d'Hydro-Québec. C'est la méthode la plus simple et rapide — il suffit de signer électroniquement en quelques minutes et nous nous occupons du reste. Si vous préférez ne pas donner de procuration, vous pouvez aussi télécharger vos données vous-même depuis votre Espace Client Hydro-Québec (voir la question plus bas).", en: "A procuration is an authorization that allows us to access your detailed consumption profile (hour-by-hour) from Hydro-Québec. It's the simplest and fastest method — just sign electronically in a few minutes and we take care of the rest. If you prefer not to give authorization, you can also download your data yourself from Hydro-Québec's Online Portal (see the question below)." },

  "faq.item6.question": { fr: "Puis-je fournir mes données de consommation moi-même?", en: "Can I provide my consumption data myself?" },
  "faq.item6.answer": { fr: "Oui! Si vous préférez ne pas nous donner de procuration, vous pouvez télécharger vous-même vos fichiers CSV depuis votre Espace Client Hydro-Québec. Comptez environ 30 minutes pour télécharger les 12 à 24 fichiers nécessaires (un par période de facturation). Nous avons préparé un guide détaillé pour vous accompagner.", en: "Yes! If you prefer not to give us authorization, you can download your CSV files yourself from Hydro-Québec's Online Portal. Allow approximately 30 minutes to download the 12 to 24 required files (one per billing period). We've prepared a detailed guide to walk you through the process." },

  "faq.item7.question": { fr: "Quelle est la durée de vie des panneaux solaires?", en: "What is the lifespan of solar panels?" },
  "faq.item7.answer": { fr: "Les panneaux solaires modernes ont une durée de vie de 25-30 ans avec une garantie de performance. Après 25 ans, ils continuent à produire de l'électricité, généralement à 80% de la capacité initiale. L'inverter, qui convertit l'électricité CC en CA, dure généralement 10-15 ans et peut être remplacé au besoin. Les onduleurs modernes sont très fiables et rarement besoin de maintenance.", en: "Modern solar panels have a lifespan of 25-30 years with a performance warranty. After 25 years, they continue generating electricity, typically at 80% of initial capacity. The inverter, which converts DC to AC power, typically lasts 10-15 years and can be replaced if needed. Modern inverters are highly reliable and rarely require maintenance." },

  "faq.item8.question": { fr: "Le solaire augmente-t-il la valeur de mon bâtiment?", en: "Does solar increase my building's property value?" },
  "faq.item8.answer": { fr: "Oui. Les études montrent que les bâtiments avec systèmes solaires se vendent entre 3-4% plus cher, soit environ 1 000$/kW installé en valeur ajoutée. Au-delà de la valeur immédiate, les acheteurs apprécient les factures énergétiques réduites et les faibles coûts d'exploitation. Si vous louez des espaces, les locataires sont de plus en plus attirés par les bâtiments durables et à faible consommation énergétique.", en: "Yes. Studies show that buildings with solar systems sell for 3-4% more, representing approximately $1,000/kW installed in added value. Beyond immediate value, buyers appreciate reduced energy bills and low operating costs. If you lease space, tenants are increasingly attracted to sustainable, low-energy buildings." },

  "faq.item9.question": { fr: "Que se passe-t-il si je vends mon bâtiment?", en: "What happens if I sell my building?" },
  "faq.item9.answer": { fr: "Le système solaire reste avec le bâtiment et augmente sa valeur de revente. Les contrats d'achat-vente standard incluent le transfert du système au nouveau propriétaire. Si vous avez un contrat de financement, il peut généralement être assumé par le nouveau propriétaire ou refinancé à des conditions compétitives. La plupart des acheteurs voient le système solaire comme un atout majeur.", en: "The solar system stays with the building and increases its resale value. Standard purchase agreements include system transfer to the new owner. If you have financing, it can typically be assumed by the new owner or refinanced at competitive rates. Most buyers see the solar system as a major asset." },
};
