...
const translations: Translations = {
  ...
  "designAgreement.title": { fr: "Mandat de conception préliminaire (Étape 4)", en: "Preliminary Design Mandate (Step 4)" },
  ...
  "designAgreement.travel": { fr: "Frais de déplacement", en: "Travel costs" },
  ...
  "designAgreement.defaultPaymentTerms": { fr: "100% payable à la signature — créditable intégralement sur votre contrat EPC", en: "100% payable at signing — fully creditable toward your EPC contract" },
  ...
  // FAQ Section
  "faq.title": { fr: "Autres questions fréquentes", en: "Other Frequently Asked Questions" },
  "faq.subtitle": { fr: "Trouvez des réponses à vos autres questions sur le solaire commercial au Québec", en: "Find answers to your other questions about commercial solar in Quebec" },
