...
const MISSION_META: Record<number, {
  ...
  1: {
    ...
    descFr: "Explorez le potentiel solaire de votre bâtiment",
    descEn: "Explore the solar potential of your building",
    unlockFr: "Débloque : Simulation solaire personnalisée",
    unlockEn: "Unlocks: Personalized solar simulation",
  },
  2: {
    icon: "📐",
    ...
    descFr: "Lancez la conception de votre système solaire",
    descEn: "Launch the design of your solar system",
    unlockFr: "Débloque : Accès aux données réelles HQ + Design détaillé",
    unlockEn: "Unlocks: Real HQ data access + Detailed design",
  },
  3: {
    icon: "🏗️",
    ...
    descFr: "Le design prend forme — votre système se concrétise",
    descEn: "The design takes shape — your system materializes",
    unlockFr: "Débloque : Rapport VC0 + Projections financières calibrées",
    unlockEn: "Unlocks: VC0 report + Calibrated financial projections",
  },
  4: {
    icon: "🤝",
    ...
    descFr: "Évaluez les scénarios et passez à l'action",
    descEn: "Evaluate scenarios and take action",
    unlockFr: "Débloque : Planification construction + Diagramme GANTT",
    unlockEn: "Unlocks: Construction planning + GANTT chart",
  },
  5: {
    icon: "⚡",
    ...
    descFr: "Votre centrale prend vie — suivez chaque étape",
    descEn: "Your plant comes to life — follow every step",
    unlockFr: "Débloque : Photos quotidiennes + Monitoring en temps réel",
    unlockEn: "Unlocks: Daily photos + Real-time monitoring",
  },
  6: {
    icon: "🌟",
    ...
    descFr: "Votre système produit — devenez ambassadeur solaire",
    descEn: "Your system is producing — become a solar ambassador",
...
function deriveMissionsFromStage(currentStage: string): Mission[] {
  ...
  const templates = [
    { num: 1, title: "Découverte Énergétique", titleEn: "Energy Discovery", stage: "qualified", points: 250,
    ...
    { num: 2, title: "Mandat de Conception", titleEn: "Design Mandate", stage: "design_mandate_signed", points: 750,
    ...
    { num: 3, title: "Design & VC0", titleEn: "Design & VC0", stage: "epc_proposal_sent", points: 500,
    ...
    { num: 4, title: "Proposition & Négociation", titleEn: "Proposal & Negotiation", stage: "won_to_be_delivered", points: 1000,
    ...
    { num: 5, title: "Construction", titleEn: "Construction", stage: "won_in_construction", points: 2000,
    ...
    { num: 6, title: "Ambassadeur Solaire", titleEn: "Solar Ambassador", stage: "won_delivered", points: 2000,
